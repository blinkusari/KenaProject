    ...
    <div class="container">
        <section class="error-404 not-found">
            ...
            <div class="error-404-content">
                <h1><?php esc_html_e('That Page Can\'t Be Found.', 'fona'); ?></h1>
                <h5><?php esc_html_e('Sorry, we couldn\'t find the page you’re looking for.', 'fona'); ?></h5>
                <?php get_search_form(); ?>
                <a href="<?php echo esc_url(home_url());?>" class="back-to-home" title="<?php esc_attr_e('Back to Home','fona')?>"><?php esc_html_e('Or Back To Home Page','fona')?></a>
            </div>
        </section>
    </div>
</main>
