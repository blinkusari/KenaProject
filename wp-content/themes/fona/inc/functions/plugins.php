...
if (!function_exists('zoo_theme_register_required_plugins')) {
    function zoo_theme_register_required_plugins()
    {
        ...
        $plugins = array(
			...
			array(
                'name' => esc_html__('Evato Market', 'fona'),
                'slug' => 'envato-market',
                'required' => true,
                'source' => $zoo_directory_plugins . 'envato-market.zip',
            ),
            array(
            ...
            array(
                'name' => esc_html__('Clever Addons Pro For Elementor', 'fona'),
                'slug' => 'cafe-pro',
                'version' => '1.2.12',
                'required' => true,
            ...
            array(
                'name' => esc_html__('CleverWooBuilder For Elementor', 'fona'),
                'slug' => 'clever-woo-builder',
                'version' => '1.0.5',
                'required' => true,
                'source' => $zoo_directory_plugins . 'clever-woo-builder.zip',
            ),
            array(
            ...
            array(
                'name' => esc_html__('Simple Local Avatars', 'fona'),
