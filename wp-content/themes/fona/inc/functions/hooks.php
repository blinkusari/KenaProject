 ...
 * */
add_action('zoo_before_post_item', 'zoo_post_item_thumbnail', 20);
 ...
 * */
if (!function_exists('zoo_post_item_thumbnail')) {
 ...
 * @uses use function and hook to zoo_post_item_thumbnail
 * */
if (!function_exists('zoo_post_item_info')) {
 ...
 * @uses use function and hook to zoo_post_item_thumbnail
 * */
if (!function_exists('zoo_post_item_cat')) {
...
/**
 * zoo_post_item_readmore
 * Get template post item thumbnail for loop
 * @uses use function and hook to zoo_post_item_readmore
 * */
if (!function_exists('zoo_post_item_readmore')) {
    function zoo_post_item_readmore()
    {
        if (get_theme_mod('zoo_enable_loop_readmore', '1') == 1 || get_the_title() == '') {
            ?>
            <a href="<?php echo esc_url(the_permalink()); ?>"
               class="readmore"><?php echo esc_html__('Read more', 'fona'); ?><i class="cs-font clever-icon-arrow-right-5"></i> </a>
            <?php
        }
    }
}
 ...
 * */
if (!function_exists('zoo_single_post_sticky_label')) {
...
/**
 * zoo_single_post_category
 * Get sticky label template
 * @uses hook to zoo_before_single_post_title
 * */
if (!function_exists('zoo_single_post_category')) {
    function zoo_single_post_category()
    {
        get_template_part('inc/templates/posts/single/post','cat');
    }
}
add_action('zoo_before_single_post_title', 'zoo_single_post_category', 10);
 ...
 * @uses hook to zoo_before_single_post_title
 * */
if (!function_exists('zoo_single_post_info')) {
 ...
 * */
if (!function_exists('zoo_single_post_media')) {
...
/**
 * zoo_single_post_gallery
 * Get media template of single post
 * @uses hook to zoo_before_single_content
 * */
if (!function_exists('zoo_single_post_gallery')) {
    function zoo_single_post_gallery()
    {
        get_template_part('inc/templates/posts/single/gallery');
    }
}
add_action('zoo_before_main_content', 'zoo_single_post_gallery', 10);
 ...
 * */
if (!function_exists('zoo_single_post_pagination')) {
 ...
 * @uses hook to zoo_after_single_content
 * */
if (!function_exists('zoo_single_post_bottom_content')) {
 ...
 * */
if (!function_exists('zoo_single_post_about_author')) {
 ...
 * @uses hook to zoo_single_post_bottom
 * */
if (!function_exists('zoo_single_post_navigation')) {
 ...
 * @uses hook to zoo_single_post_bottom
 * */
if (!function_exists('zoo_single_post_related')) {
    function zoo_single_post_related()
    {
        get_template_part('inc/templates/posts/single/related', 'posts');
    }
}
add_action('zoo_after_single_main_content', 'zoo_single_post_related', 10);
