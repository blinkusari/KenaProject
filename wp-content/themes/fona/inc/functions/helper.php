 ...
 * */
if (!function_exists('zoo_main_content_css')) {
 ...
 * */
if (!function_exists('zoo_loop_content_css')) {
 ...
 * */
if (!function_exists('zoo_single_content_css')) {
    function zoo_single_content_css()
    {
        ...
        $header_align=get_post_meta(get_the_ID(),'zoo_blog_single_header_align',true);
        if($header_align=='inherit'||$header_align==''){
            $header_align=get_theme_mod('zoo_blog_single_post_header_align','center');
        }
...
if (!function_exists('zoo_password_form')) {
    function zoo_password_form()
    {
        ...
        $zoo_form = '<div class="zoo-form-login"><form action="' . esc_url(home_url('wp-login.php?action=postpass', 'login_post')) . '" method="post"><h4>
...
if (!function_exists('zoo_site_width')) {
    function zoo_site_width()
    {
        ...
        if (zoo_site_layout() != 'full-width') {
            $zoo_site_width = get_theme_mod('zoo_site_max_width', '1170');
            ...
            if (class_exists('WooCommerce', false)) {
                if(is_shop() || is_product_category()) {
                    $zoo_site_width = get_theme_mod('zoo_shop_max_width', '1170');
                }
            }
...
if (!function_exists('zoo_get_image_sizes')) {
    function zoo_get_image_sizes()
    {
        ...
        endforeach;
        $output['full'] = esc_html__('Full', 'fona');
 ...
 * @return array pages
 * */
if (!function_exists('zoo_get_pages')) {
