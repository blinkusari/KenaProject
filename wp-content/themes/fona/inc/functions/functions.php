...
if(!function_exists('zoo_bottom_footer')) {
    function zoo_bottom_footer()
    {
        ...
        if(get_theme_mod('zoo_enable_back_top_top','1')){
            ?>
            <a id="zoo-back-to-top" href="#cafe-site-header" title="<?php echo esc_attr__('Back to Top','fona')?>"><i class="cs-font clever-icon-up"></i></a>
            <?php
        }
    }
}
 ...
 **/
if (!function_exists('zoo_site_customizer')) {
 ...
 *
*/
if (!function_exists('zoo_contact_icon')) {
