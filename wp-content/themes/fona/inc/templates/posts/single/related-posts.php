...
if ( get_theme_mod( 'zoo_enable_blog_related', '1' ) == 1 ) {
	...
	if ( $zoo_related_query->have_posts() ) {
		$class = 'post-loop-item post-loop-item grid-layout-item ';
		...
		?>
        <section class="post-related wrap-loop-content grid-layout container-fluid">
        	<div class="container">
        		<div class="row">
        	<div class=" col-12 col-xl-10">
            <h3 class="title-block"><?php esc_html_e( 'You may also like', 'fona' ); ?></h3>
            <div class="row">
