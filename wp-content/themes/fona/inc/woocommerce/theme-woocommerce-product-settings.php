...
function zoo_advanced_product_tab( $tabs ) {
	$tabs['zoo_adv_tab'] = array(
		'label'  => esc_html__( 'Zoo Advanced', 'fona' ),
		'target' => 'zoo_adv_tab',
...
function zoo_advanced_product_tab_content() {
    ...
    <div class='options_group'><?php
		woocommerce_wp_text_input( array(
			...
			'label'             => __( 'Number product on event', 'fona' ),
			'desc_tip'          => 'true',
			'description'       => __( 'Use for display product stock countdown  bar. Product must on sale and Manage stock is enable.', 'fona' ),
			'type'              => 'number',
