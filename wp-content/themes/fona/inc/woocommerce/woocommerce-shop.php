 ...
 * Add button wishlist to hook woocommerce_after_add_to_cart_form of single product page
...
if (get_theme_mod('zoo_enable_wishlist', '1') == 1) {
    add_action('woocommerce_after_add_to_cart_form', 'zoo_button_wishlist', 10, 0);
 ...
 * Add button compare to hook woocommerce_after_add_to_cart_form of single product page
...
if (get_theme_mod('zoo_enable_compare', '1') == 1) {
    add_action('woocommerce_after_add_to_cart_form', 'zoo_button_products_compare', 10, 0);
    if (get_theme_mod('zoo_enable_shop_loop_compare', '1') == 1) {
...
add_action('zoo_woo_breadcrumbs', 'woocommerce_breadcrumb', 5);
...
if (!function_exists('zoo_product_sidebar')) {
    ...
    {
        $zoo_product_sidebar = get_theme_mod('zoo_shop_sidebar', 'left');
...
if (!function_exists('zoo_wrap_shop_loop_class')) {
    ...
    {
        $css_class ='';
        if((zoo_product_sidebar()=="left"||zoo_product_sidebar()=="right")&&is_active_sidebar('shop')) {
...
add_action('woocommerce_before_shop_loop', 'zoo_open_top_products_page', 5);
/**
            ...
            <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"
               class="wrap-img">
                ...
                if ($zoo_img) :
                    ...
                    printf('<img src="%s" alt="%s" class="wp-post-image" />', esc_url(wc_placeholder_img_src('woocommerce_thumbnail')), esc_html__('Awaiting product image', 'fona'));
                endif;
...
if (get_theme_mod('zoo_enable_shop_loop_cart', '1') != 1 || zoo_enable_catalog_mod()) {
