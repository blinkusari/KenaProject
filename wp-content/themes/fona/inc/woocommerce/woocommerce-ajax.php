 ...
 * Add single product to cart by using ajax and return ajax cart fragments.
 * @return json.
 */
add_action('wp_ajax_zoo_add_single_product_to_cart', 'zoo_add_single_product_to_cart');
add_action('wp_ajax_nopriv_zoo_add_single_product_to_cart', 'zoo_add_single_product_to_cart');

function zoo_add_single_product_to_cart() {
