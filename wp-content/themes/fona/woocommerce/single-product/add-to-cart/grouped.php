			...
			foreach ( $grouped_products as $grouped_product_child ) {
				...
				foreach ( $grouped_product_columns as $column_id ) {
					...
					switch ( $column_id ) {
                        ...
                        break;
                    case 'label':
                        $value  = '<h3 class="product-loop-title">';
                        ...
                        $value .= '</h3>';
                        $value .= '<div class="price">'.$grouped_product_child->get_price_html().'</div>' . wc_get_stock_html( $grouped_product_child );
                        break;
                    case 'image':
                        $value = get_the_post_thumbnail($grouped_product_child->get_id(),array(80,80));
                        break;
                    default:
                        $value = '';
                        break;
