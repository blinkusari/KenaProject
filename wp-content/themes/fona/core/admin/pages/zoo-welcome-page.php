            ...
            <div id="zoo-welcome-panel" class="zoo-welcome-panel">
                <div class="zoo-welcome-panel-content">
                    <div class="zoo-welcome-heading">
                    	...
                    	<p><?php printf(esc_html__( 'Thank you for choosing %s! Get ready to build something beautiful. Please register your purchase to get automatic theme updates, import sample data and install premium plugins. Check out theme documentation and our support center to learn how to receive product support and how to make awesome things with this theme. We hope you enjoy it!', 'fona'), $this->theme->name); ?></p>
                    </div>
            ...
            <div class="dashboard-widgets-wrap">
                <div id="dashboard-widgets" class="metabox-holder">
                    <table class="system-status widefat" cellspacing="0">
                    	...
                    	<tbody>
                            <tr>
                				<td data-export-label="MySQL Version"><?php esc_html_e('MySQL version:', 'fona') ?></td>
                    		...
                    		<tr>
                				<td><?php esc_html_e('PHP post max size:', 'fona') ?></td>
                				<td><?php echo ini_get('post_max_size') ?></td>
                			</tr>
                			<tr>
                				<td><?php esc_html_e('PHP max execution time:', 'fona') ?></td>
                				<td><?php echo ini_get('max_execution_time') ?></td>
                			</tr>
                			<tr>
                				<td><?php esc_html_e('PHP max input vars:', 'fona') ?></td>
                				<td><?php echo ini_get('max_input_vars') ?></td>
                			</tr>
                            <tr>
                    			<td><?php esc_html_e('max upload size:', 'fona') ?></td>
                			...
                			<tr>
                				<td><?php esc_html_e('WordPress multisite:', 'fona') ?></td>
                				<td><?php echo esc_html($multisize) ?></td>
                			</tr>
                            <tr>
                    			<td><?php esc_html_e('WordPress debug mode:', 'fona') ?></td>
                    			<td><?php echo esc_html($wp_debug_mode) ?></td>
                    		</tr>
                            <tr>
                    			<td><?php esc_html_e('WordPress active plugins:', 'fona') ?></td>
