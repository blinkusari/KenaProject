...
final class CleverSiteLogo extends CleverWidgetBase
{
    ...
    {
        return __('CAFE Site Logo', 'cafe-pro');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control( 'logo_height', [
            'label'     => esc_html__('Logo Height', 'cafe-pro' ),
            'description'     => esc_html__('Not include padding/margin.', 'cafe-pro' ),
        ...
        $this->add_control( 'sticky_logo_height', [
            'label'     => esc_html__('Sticky Height', 'cafe-pro' ),
            'type'      => Controls_Manager::SLIDER,
            'range'     => [
                'px' => [
                    'min' => 0,
