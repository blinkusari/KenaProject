...
final class CleverCanvasCart extends CleverWidgetBase
{
    ...
    {
        return __('CAFE Canvas Cart', 'cafe-pro');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'after',
                'selectors' => [
                    '{{WRAPPER}} .cafe-wrap-icon-cart>.cafe-cart-count' => 'margin:  {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'cart_label_typo',
                'scheme' => Typography::TYPOGRAPHY_1,
                'selector' => '{{WRAPPER}} .cafe-cart-label',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .cafe-wrap-icon-cart .cafe-cart-label'  => 'color: {{VALUE}}'
                ]
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .cafe-canvas-cart:hover .cafe-cart-label'  => 'color: {{VALUE}}'
                ]
            ]
        );
        $this->add_control(
