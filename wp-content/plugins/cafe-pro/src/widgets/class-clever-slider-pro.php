...
final class CleverSliderPro extends CleverWidgetBase
{
    ...
    {
        return esc_html__('CAFE Slider Pro', 'cafe-pro');
    }
    ...
    {
        return ['imagesloaded', 'slick', 'cafe-pro-frontend'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section('section_slides', [
            'label' => esc_html__('Slides', 'cafe-pro'),
        ]);
        $repeater = new Repeater();
        $repeater->add_control('slide_name', [
            'label'       => esc_html__('Name', 'cafe-pro'),
            'type'        => Controls_Manager::TEXT,
            'placeholder'     => esc_html__('Slide Name', 'cafe-pro'),
            'default'     => esc_html__('Slide Name', 'cafe-pro')
        ]);

        $repeater->add_control('slide_template', [
            'label'     => esc_html__('Template', 'cafe-pro'),
        ...
        $this->add_responsive_control('slides_height', [
            'label'      => esc_html__('Container Height', 'cafe-pro'),
        ...
        $this->add_responsive_control('slides_width', [
            'label'      => esc_html__('Container Width', 'cafe-pro'),
            'type'       => Controls_Manager::SLIDER,
            'range'      => [
                'px' => [
                    'min' => 100,
        ...
        $this->start_controls_section('section_slider_options', [
            'label' => esc_html__('Slider Settings', 'cafe-pro'),
            'type'  => Controls_Manager::SECTION,
        ]);
        $this->add_responsive_control('show_arrows', [
            'label'          => esc_html__('Show Arrows', 'cafe-pro'),
        ...
        $this->add_responsive_control('show_dots', [
            'label'   => esc_html__('Show Dots', 'cafe-pro'),
            'type'    => Controls_Manager::SWITCHER,
            'default' => 'yes',
        ]);
        $this->add_control('pause_on_hover', [
            'label'   => esc_html__('Pause on Hover', 'cafe-pro'),
            'type'    => Controls_Manager::SWITCHER,
            'default' => 'yes',
        ]);

        $this->add_control('autoplay', [
            'label'   => esc_html__('Autoplay', 'cafe-pro'),
            'type'    => Controls_Manager::SWITCHER,
            'default' => 'yes',
        ]);

        $this->add_control('autoplay_speed', [
            'label'     => esc_html__('Autoplay Speed', 'cafe-pro'),
        ...
        $this->add_control('infinite', [
            'label'   => esc_html__('Infinite Loop', 'cafe-pro'),
            'type'    => Controls_Manager::SWITCHER,
            'default' => 'yes',
        ]);

        $this->add_control('transition_speed', [
            'label'   => esc_html__('Transition Speed (ms)', 'cafe-pro'),
            'type'    => Controls_Manager::NUMBER,
            'default' => 500,
        ]);
        ...
        $this->start_controls_section('heading_style_arrows', [
            'label' => esc_html__('Arrows', 'cafe-pro'),
        ...
        $this->add_control('arrow_left_icon', [
            'label'     => esc_html__('Arrow Left', 'cafe-pro'),
            'type'      => 'clevericon',
            'condition' => [
                'show_arrows' => 'yes',
            ],
        ...
        $this->add_control('arrow_right_icon', [
            'label'     => esc_html__('Arrow Right', 'cafe-pro'),
            'type'      => 'clevericon',
            'condition' => [
                'show_arrows' => 'yes',
            ],
        ...
        $this->add_control('arrows_position', [
            'label'     => esc_html__('Arrows Position', 'cafe-pro'),
            'type'      => Controls_Manager::SELECT,
            'default'   => 'inside',
            'options'   => [
                'inside'  => esc_html__('Inside', 'cafe-pro'),
                'outside' => esc_html__('Outside', 'cafe-pro'),
            ],
            'condition' => [
                'show_arrows' => 'yes',
            ],
        ...
        $this->add_control('arrows_size', [
            'label'     => esc_html__('Arrows Size', 'cafe-pro'),
            'type'      => Controls_Manager::SLIDER,
            'range'     => [
                'px' => [
                    'min' => 20,
        ...
        $this->add_control('arrows_color', [
            'label'     => esc_html__('Arrows Color', 'cafe-pro'),
        ...
        $this->add_control('arrows_color_hover', [
            'label'     => esc_html__('Arrows Color Hover', 'cafe-pro'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->start_controls_section('heading_style_dots', [
            'label' => esc_html__('Dots', 'cafe-pro'),
            'tab'   => Controls_Manager::TAB_STYLE,
            'condition' => [
                'show_dots' => 'yes',
            ],
        ...
        $this->add_control('dots_style', [
            'label'     => esc_html__('Dots Style', 'cafe-pro'),
            'type'      => Controls_Manager::SELECT,
            'default'   => 'dots',
            'options'   => [
                'dots'  => esc_html__('Dots', 'cafe-pro'),
                'line'  => esc_html__('Line', 'cafe-pro'),
                'group' => esc_html__('Group', 'cafe-pro'),
            ],
            'condition' => [
                'show_dots' => 'yes',
            ],
        ...
        $this->add_control('dots_position', [
            'label'     => esc_html__('Dots Position', 'cafe-pro'),
            'type'      => Controls_Manager::SELECT,
            'default'   => 'inside',
            'options'   => [
                'outside' => esc_html__('Outside', 'cafe-pro'),
        ...
        $this->add_control('dots_size', [
            'label'     => esc_html__('Dots Size', 'cafe-pro'),
            'type'      => Controls_Manager::SLIDER,
            'range'     => [
                'px' => [
                    'min' => 5,
        ...
        $this->add_control('dots_color', [
            'label'     => esc_html__('Dots Color', 'cafe-pro'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
