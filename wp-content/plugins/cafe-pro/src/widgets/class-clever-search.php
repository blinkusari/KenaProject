...
final class CleverSearch extends CleverWidgetBase
{
    ...
    {
        return __('CAFE Search', 'cafe-pro');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control('icon', [
            ...
            'type' => 'clevericon',
            'default' => 'cs-font clever-icon-search-6',
        ]);
        $this->add_control(
            'show_label',
            [
        ...
        $this->add_control('label', [
            ...
            'description' => __('Label for display at where place widget', 'cafe-pro'),
            'type' => Controls_Manager::TEXT,
            'default' => __('Search', 'cafe-pro'),
            'condition' => [
                'show_label' => 'yes'
            ],
        ]);
        ...
        $this->add_control('search_by_SKU', [
            'label' => __('Search by SKU', 'cafe-pro'),
            'type' => Controls_Manager::SWITCHER,
            'return_value' => 'true',
            'default' => 'false',
            'condition' => [
            ...
            'description' => esc_html__('This option will allow search products by SKU but will take more search for search.', 'cafe-pro'),
        ]);
        ...
        $this->add_control('columns', [
            'label' => esc_html__('Columns for row', 'cafe-pro'),
        ...
        $this->add_control('columns_tablet', [
            'label' => esc_html__('Columns for row (Tablet)', 'cafe-pro'),
            'type' => Controls_Manager::SLIDER,
            'range' => [
                'col' => [
                    'min' => 1,
        ...
        $this->add_control('columns_mobile', [
            'label' => esc_html__('Columns for row (Mobile)', 'cafe-pro'),
            'type' => Controls_Manager::SLIDER,
            'range' => [
                'col' => [
                    'min' => 1,
        ...
        $this->add_control(
            'search_label_color',
            [
                'label' => esc_html__('Label Color', 'cafe-pro'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .cafe-search-toggle-button .cafe-search-label' => 'color: {{VALUE}}'
                ]
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'search_label_hv_color',
            [
                'label' => esc_html__('Label Color', 'cafe-pro'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .cafe-search-toggle-button:hover .cafe-search-label' => 'color: {{VALUE}}'
                ]
            ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .cafe-search-label',
            ]
        );
        ...
        $this->add_control(
            'search_sm_btn_color_hover',
            [
                'label' => esc_html__('Color Hover', 'cafe-pro'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .cafe-wrap-search-fields .cafe-search-submit:hover' => 'color: {{VALUE}}'
                ]
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'search_sm_btn_bg_hover',
            [
                'label' => esc_html__('Background Color Hover', 'cafe-pro'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .cafe-wrap-search-fields .cafe-search-submit:hover' => 'background-color: {{VALUE}}'
                ]
            ]
        );
        $this->add_group_control(
