...
<div class="cafe-wrap-search <?php echo esc_attr($settings['layout']); ?>">
    ...
    if ($settings['layout'] != 'normal') {
        ...
        <label class="cafe-search-toggle-button" for="<?php echo esc_attr($toggle_id); ?>">
            <?php if($settings['icon']!=''){?>
                <i class="<?php echo esc_attr($settings['icon'])?>"></i>
            <?php }
            if($settings['show_label']!=''){?>
                <span class="cafe-search-label"><?php echo esc_html($settings['label'])?></span>
            <?php }?>
        </label>
        ...
        <div class="cafe-wrap-search-form-content">
            <div class="cafe-wrap-search-fields">
                ...
                if ($settings['search_product_only'] == 'true') {
                    ...
                    <?php
                }if ($settings['search_by_SKU'] == 'true') {
                    ?>
