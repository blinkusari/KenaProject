...
?>
    ...
    <div class="cafe-canvas-cart-content widget_shopping_cart woocommerce<?php echo esc_attr(WC()->cart->is_empty() ? " cart-empty" : "") ?>">
        <div class="cafe-heading-cart-content">
            <?php esc_html_e('Cart', 'woocommerce'); ?>
            (<span class="cafe-cart-count"><?php echo esc_html(WC()->cart->get_cart_contents_count()); ?></span>)
            <span class="cafe-close-cart"><?php esc_html_e('Close', 'woocommerce'); ?><i
