...
final class Plugin
{
     ...
     * @var string
     */
    const OPTION_NAME = 'cafe_pro_settings';
    ...
    public function _install()
    {
        ...
        load_textdomain( 'cafe-pro', CAFE_PRO_DIR.'languages/cafe-pro-'.determine_locale().'.mo' );
    ...
    function _registerWidgetsCategory()
    {
        ...
        $elementor->elements_manager->add_category('clever-builder-elements', [
            'title' => esc_html__('CAFE Header/Footer Elements', 'cafe-pro'),
            'icon'  => 'fa fa-asterisk',
        ], 5);
