...
function zoo_render_header_attributes_metabox()
{
	...
	$saved_header_templates    = get_option(ZOO_THEME_SLUG.'_header_saved_templates', []);
	$prebuilt_header_templates = get_option(ZOO_THEME_SLUG.'_header_prebuilt_templates', []);
	?>
