...
function zoo_render_footer_attributes_metabox()
{
	...
	$saved_footer_templates    = get_option(ZOO_THEME_SLUG.'_footer_saved_templates', []);
	$prebuilt_footer_templates = get_option(ZOO_THEME_SLUG.'_footer_prebuilt_templates', []);
