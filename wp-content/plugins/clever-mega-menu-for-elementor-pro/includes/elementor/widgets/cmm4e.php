...
final class Cmm4eElementorWidget extends Widget_Base
{
    ...
    {
        return esc_html__('Clever Mega Menu', 'clever-mega-menu-pro-for-elementor');
    }
    ...
    protected function register_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Menu Content', 'clever-mega-menu-pro-for-elementor'),
            ]
        );
        ...
        $this->add_control(
            'menu_theme',
            [
                'label' => esc_html__('Skin', 'clever-mega-menu-pro-for-elementor'),
        ...
        $this->add_control(
            'menu_location',
            [
                'label' => esc_html__('Location', 'clever-mega-menu-pro-for-elementor'),
                'type' => Controls_Manager::SELECT,
                'default' => '',
    ...
    protected function render()
    {
        ...
        if (!empty($settings['menu_location'])) {
            ...
            esc_html_e('No menu location selected.', 'clever-mega-menu-pro-for-elementor');
        }
    }
    ...
    {
        $presets = [
            'none' => esc_html__('None', 'clever-mega-menu-pro-for-elementor')
        ];
        ...
        if (!empty($posts)) {
            foreach ($posts as $post) {
                $presets[$post->post_name] = $post->post_title ? : esc_html__('Untitled Menu Skin', 'clever-mega-menu-pro-for-elementor');
            }
        }
