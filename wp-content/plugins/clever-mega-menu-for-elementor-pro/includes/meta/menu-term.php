    ...
    function _render($menu_id = false, $html = false)
    {
        ...
        <?php endif; ?>
            <div class="clever-mega-menu-settings">
                <h3><?php esc_html_e('Clever Mega Menu for Elementor Settings', 'clever-mega-menu-pro-for-elementor'); ?></h3>
                <fieldset class="menu-settings-group">
                    <legend class="menu-settings-group-name howto"><?php esc_html_e('Enable', 'clever-mega-menu-pro-for-elementor'); ?></legend>
                    <div class="menu-settings-input checkbox-input">
                        <input id="clever-mega-menu-enable-checkbox" type="checkbox" value="1" <?php checked($settings['enabled']) ?> name="<?php $this->field('enabled') ?>">
                        <label for="clever-mega-menu-enable-checkbox"><?php esc_html_e('Whether to enable Mega Menu for this menu or not.', 'clever-mega-menu-pro-for-elementor') ?></label>
                    </div>
                </fieldset>
                <fieldset class="menu-settings-group clever-mega-menu-advanced-setting">
                    <legend class="menu-settings-group-name howto"><?php esc_html_e('SEO markup', 'clever-mega-menu-pro-for-elementor'); ?></legend>
                    <div class="menu-settings-input checkbox-input">
                        <input id="clever-mega-menu-enable-se-markup-checkbox" type="checkbox" value="1" <?php checked($settings['se_markup']) ?> name="<?php $this->field('se_markup') ?>">
                        <label for="clever-mega-menu-enable-se-markup-checkbox"><?php echo sprintf(esc_html__('Whether to add %sschema markups%s for this menu or not.', 'clever-mega-menu-pro-for-elementor'), '<a href="https://schema.org/SiteNavigationElement">', '</a>') ?></label>
                    </div>
                </fieldset>
                <fieldset class="menu-settings-group clever-mega-menu-advanced-setting">
                    <?php
                    ...
                    ?>
                    <legend class="menu-settings-group-name howto"><?php esc_html_e('Menu skin', 'clever-mega-menu-pro-for-elementor'); ?></legend>
                    <div class="menu-settings-input checkbox-input">
                        <select id="clever-mega-menu-theme" name="<?php $this->field('theme') ?>">
                        ...
                        <label for="clever-mega-menu-theme"><?php printf(esc_html__('Select a menu skin or %screate a new one%s.', 'clever-mega-menu-pro-for-elementor'), '<a href="' . admin_url('post-new.php?post_type=cmm4e_menu_theme') . '">', '</a>') ?></label>
                    </div>
                </fieldset>
                <?php if (!empty($current_location) && !empty($settings['theme'])): ?>
                <fieldset class="menu-settings-group clever-mega-menu-advanced-setting">
                    <legend class="menu-settings-group-name howto"><?php esc_html_e('Menu shortcode', 'clever-mega-menu-pro-for-elementor'); ?></legend>
                    <div class="menu-settings-input checkbox-input">
    ...
    function _change_nav_menu_args($args)
    {
        ...
        if ($menu_theme) {
            ...
            if ('horizontal' === $menu_style) {
                ...
                $position = !empty($theme_meta['menubar_horizontal_position']) ? $theme_meta['menubar_horizontal_position'] : 'position-relative';
                $menu_style_classes .= ' cmm4e-' . $position;
            } else {
