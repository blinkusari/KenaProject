    ...
    <?php else : ?>
        <ul class="variations zoo-cw-variations">
            ...
            foreach ($attributes as $attribute_name => $options) :
                ...
                $zoo_cw_attribute = $zoo_cw_name_attr_selected = $zoo_cw_attribute_options = $zoo_cw_label = $zoo_cw_attr_class = '';
                if (isset($product_swatch_data_array[$attribute_slug])) {
                    ...
                    $zoo_cw_label = $product_swatch_data_array[$attribute_slug]['label'];
                    if ($selected != '') {
                ...
                <li class="<?php echo esc_attr($zoo_cw_tr_class) ?>">
                    <div class="label">
                        <label>
                            <?php echo esc_html($zoo_cw_label); ?>:
                        </label>
