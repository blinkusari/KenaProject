    ...
    <div class="cafe-wrap-content">
        ...
        if ($settings['effect'] == 'overlay-box') {
            ...
            <div class="cafe-overlay-box">
                <?php
                printf('<%s %s>%s</%s>',Utils::validate_html_tag( $settings['title_tag']), $this->get_render_attribute_string('title'), $settings['title'], Utils::validate_html_tag($settings['title_tag']));
                ?>
