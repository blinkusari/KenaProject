                 ...
                 <div <?php echo $this->get_render_attribute_string('vertical_scroll_dots'); ?>>
                     <ul <?php echo $this->get_render_attribute_string('vertical_scroll_dots_list'); ?>>
                         <?php foreach ($templates as $index => $section) : ?>
                             <li data-index="<?php echo esc_attr($index); ?>" data-menuanchor="<?php echo esc_attr($checkType ? 'section_' . $id . $index : $templates[$index]['section_id']); ?>" class="cafe-scrollto-nav-item" data-label="<?php echo esc_attr($section['label']) ?>">
                                 <div class="cafe-scrollto-nav-item-link"><i class="<?php echo esc_attr($section['icon']) ?>"></i>
                                     <?php if($settings['dots_tooltips_switcher']=='yes'){?><span class="label"><?php echo esc_html($section['label']) ?></span><?php }?>
                                 </div>
                             </li>
                         <?php endforeach; ?>
                     </ul>
