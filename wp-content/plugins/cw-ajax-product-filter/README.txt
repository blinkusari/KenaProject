...
Clever WooCommerce Ajax Product Filter - adds advanced products filtering to your shop.

== Description ==

Clever WooCommerce Ajax Product Filter - is a plugin that allows you to filter your products easily by categories, attributes, prices. Your can sort products, navigate to next and previous pages without reloading the page.
